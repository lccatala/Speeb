...
entity_ai_status        = entity_ai_aim_y+1
entity_next_action      = entity_ai_status+1  ;; control system! 2 bytes
...
.macro entity_fill _ENTITY, _Y_SPEED, _X_COORD, _Y_COORD, _WIDTH, _HEIGHT, _COLOR, _AI_STATUS
    ...
    ld entity_ai_status(ix),     _AI_STATUS
...
.macro entity_create_prototype _Y_SPEED, _WIDTH, _HEIGHT, _COLOR, _AI_STATUS
    ...
    blank_bytes entity_ai_status-(entity_color+1)
    .db _AI_STATUS          ;; entity_color
    blank_bytes entity_next_action-(entity_ai_status+1)
    .db #0x00
